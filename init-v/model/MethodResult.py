...
class MethodResult:
    ...
    def __init__(self, pca_result: list[(float, float, str)], autoencoder_result: list[(float, float, str)]):
    ...
    def get_pca_result(self) -> list[(float, float, str)]:
        """Getter of the PCA result."""
        return self.pca_result

    def get_autoencoder_result(self) -> list[(float, float, str)]:
